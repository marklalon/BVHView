/*******************************************************************************************
*
*    models.c - Embedded capsule OBJ and LoadOBJFromMemory implementation
*
*******************************************************************************************/
...
Model LoadOBJFromMemory(const char *fileText)
{
    ...
    if (fileText != NULL)
    {
        ...
        RL_FREE(matFaces); RL_FREE(vCount); RL_FREE(vtCount); RL_FREE(vnCount); RL_FREE(faceCount);
    }
